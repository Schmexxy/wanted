...
local propspec_toggle = CreateConVar("wntd_spec_prop_control", "1")

local propspec_base = CreateConVar("wntd_spec_prop_base", "8")
local propspec_min = CreateConVar("wntd_spec_prop_maxpenalty", "-6")
local propspec_max = CreateConVar("wntd_spec_prop_maxbonus", "16")
...
local propspec_force = CreateConVar("wntd_spec_prop_force", "110")
...
local propspec_retime = CreateConVar("wntd_spec_prop_rechargetime", "1")
