...
vgui.Register("WNTDScorePlayerInfoBase", PANEL, "Panel")
...
vgui.Register("WNTDScorePlayerInfoSearch", PANEL, "WNTDScorePlayerInfoBase")
...
vgui.Register("WNTDScorePlayerInfoTags", PANEL, "WNTDScorePlayerInfoBase")
