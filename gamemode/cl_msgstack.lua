...
-- This is some of the oldest WNTD code, and some of the first Lua code I ever
...
function MSTACK:Draw(client)
   ...
   for k, item in pairs(self.msgs) do
      if item.time < CurTime() then
         ...
         draw.RoundedBox(0, top_x, y, msg_width, height, item.bg)
...
net.Receive("WNTD_GameMsg", ReceiveGameMsg)
...
net.Receive("WNTD_GameMsgColor", ReceiveCustomMsg)
