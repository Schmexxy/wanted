...
local allow_rag  = CreateConVar("wntd_ragdoll_carrying", "1")
local prop_force = CreateConVar("wntd_prop_carrying_force", "60000")
local no_throw   = CreateConVar("wntd_no_prop_throwing", "0")
local pin_rag    = CreateConVar("wntd_ragdoll_pinning", "1")
local pin_rag_inno = CreateConVar("wntd_ragdoll_pinning_innocents", "0")
...
local allow_wep = CreateConVar("wntd_weapon_carrying", "0")
local wep_range = CreateConVar("wntd_weapon_carrying_range", "50")
...
local function PlayerStandsOn(ent)
   for _, ply in pairs(player.GetAll()) do
      if ply:GetGroundEntity() == ent and ply:IsActivePlayer() then
         return true
      end
   end
