...
CreateConVar("wntd_no_nade_throw_during_prep", "0")
...
function SWEP:PrimaryAttack()
   ...
   if GetRoundState() == ROUND_PREP and GetConVar("wntd_no_nade_throw_during_prep"):GetBool() then
      return
   end
