...
function ShowC4Config(bomb)
   ...
   dgrab.DoClick = function()
                      ...
                      RunConsoleCommand("wntd_c4_pickup", bomb:EntIndex())
                      dframe:Close()
                   end
   ...
   ddestroy.DoClick = function(s)
                         ...
                         if not s.Confirmed then
                            ...
                            RunConsoleCommand("wntd_c4_destroy", bomb:EntIndex())
                            dframe:Close()
                         end
                   end
   ...
   dconf.DoClick = function()
                      ...
                      if t and tonumber(t) then
                         ...
                         RunConsoleCommand("wntd_c4_config", bomb:EntIndex(), t)
                         dframe:Close()
                      end
                   end
...
function ShowC4Disarm(bomb)
   ...
   on_wire_cut = function(idx)
                    ...
                    if IsValid(bomb) then
                       RunConsoleCommand("wntd_c4_disarm", tostring(bomb:EntIndex()), tostring(idx))
                    end
                 end
end
...
net.Receive("wntd_C4Config", C4ConfigHook)
...
net.Receive("wntd_C4DisarmResult", C4DisarmResultHook)
